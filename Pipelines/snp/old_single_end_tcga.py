...
cmd_1='bowtie2  -x {ref} -U {srrRun}_bowtie_in --no-unal --threads {nThread} > {srrRun}_bowtie_out 2>bowtie_log.txt'.format(ref=genomeDir,srrRun=srrRun,nThread=nThread)
#take in and sort it 
if TEST:
